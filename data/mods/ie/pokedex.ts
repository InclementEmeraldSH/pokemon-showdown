export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	raticatealola: {
		...
		abilities: {0: "Gluttony", 1: "Strong Jaw", H: "Thick Fat"},
		heightm: 0.7,
		weightkg: 25.5,
		color: "Black",
		prevo: "Rattata-Alola",
	...
	wigglytuff: {
		...
		types: ["Normal", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 120, atk: 70, def: 45, spa: 105, spd: 60, spe: 45},
	...
	ledian: {
		...
		abilities: {0: "Aerilate", 1: "Early Bird", H: "Iron Fist"},
		heightm: 1.4,
		weightkg: 35.6,
		color: "Red",
		prevo: "Ledyba",
	...
	houndoommega: {
		...
		forme: "Mega",
		types: ["Dark", "Fire"],
		baseStats: {hp: 75, atk: 90, def: 100, spa: 140, spd: 90, spe: 115},
	...
	purugly: {
		...
		types: ["Normal"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 71, atk: 102, def: 74, spa: 64, spd: 69, spe: 119},
	...
	emolga: {
		...
		abilities: {0: "Static", 1: "Lighting Rod", H: "Motor Drive"},
		heightm: 0.4,
		weightkg: 5,
		color: "White",
		eggGroups: ["Field"],
	...
	elgyem: {
		...
		abilities: {0: "Telepathy", 1: "Analytic", H: "Synchronize"},
		heightm: 0.5,
		weightkg: 9,
		color: "Blue",
		evos: ["Beheeyem"],
